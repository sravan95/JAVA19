...
o1. You can add task to your ToDo List
o2. You can remove task from your ToDo List
o3. You can update the status of the task. (Mark the task as complete, in progress or incomplete)
p4. You can display all the pending / incomplete tasks from your ToDo List.
o5. You can display all the tasks based on a particular date
p6. You can find a task based on the task name.
p7. You can get all the overdue tasks.
o8. You can also display all the tasks.
